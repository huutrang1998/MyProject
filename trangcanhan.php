        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="btn btn-round btn-danger" style="background-color:#c50000; border : none" href="dangnhap.php" data-scroll="true">Trang Cá Nhân</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="home.php" data-scroll="true">Đăng xuất</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="container">
                    <div class="row">
                             <div class="row col-md-8 offset-md-4">
                                <p style="font-weight: bold;font-size: 28px">Trang ca nhan cua ban</p>
                             </div>
                             <br><br><br>
                                                <div class="row">
