   ...
   <script>$("#navbar-zone").load('navbar.php')</script>
    ...
    <div class="main">
        ...
        <div class="container" style="text-align:center;border-radius:10px;">
            <br><br>
           <?php echo '<a href=' . 'gui_don_hang.php?id=' . $_SESSION['id'] . ' class="btn btn-primary btn-round" name="delete" type="delete" style=" color: white;"> Gửi đơn hàng</a>' ?>

            <div class="container" style="text-align: center;justify-content: center;">
                <h3>Danh sách kiện hàng</h3><br><br>
                <?php
                $user=$_SESSION['id'];

                $sql = "SELECT * FROM `giohang` WHERE userID=$user ORDER BY time DESC";
                ...
                while ($row_temp = mysqli_fetch_assoc($result)) {
                 ...
                 <div class="row" style="background-color:#fafafa;border-radius:10px;">
                     ...
                     <div class="col-md-4" style="margin-top:auto; margin-bottom:auto; margin-left:0px;">
                             <a href=' . 'xoa_khoi_gio_hang.php?id=' . $row_temp['productID'] . ' class="btn btn-danger btn-round" name="delete" type="delete" style=" color: white;"> Xoá</a>
                           </div>
                     </div>
                     </form>
                     <br><br>
